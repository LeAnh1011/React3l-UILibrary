...
filterValue['organizationValue'] = [{ id: 1, name: "Ban công nghệ thông tin", code: "FIM" }, { id: 4, name: "Ban hành chính", code: "FAD" },];
filterValue['appUserValue'] = { id: 1, name: "Ban công nghệ thông tin", code: "FIM" };
